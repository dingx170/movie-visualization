  ...
  <div class="tab-content" id="nav-tabContent">
    <?php foreach ($files as $k=>$file){
      ...
      <div class="row topRowContainer">
        ...
        <div class="col-2">
          <h5 class="text-center">Movie info</h5><hr>
          <div id="<?=$f?>-info"><b>Title:</b> {{title}}<br/><b>Year:</b> {{year}}<br/><b>Director:</b> {{director}}<br/><b>Genre:</b> {{genre}}<br/><br/><b>Description:</b> {{desc}}</div>
        </div>
        ...
        <div class="col">
          ...
          <br>
          <div>
            <label><h5>Select the time interval to update charts:</h5></label>
        ...
        <div class="col">
            <h5 class="text-center">The transition and overall distribution of emotions</h5>
    ...
    <div class="row interactiveContainer chartBorder">
